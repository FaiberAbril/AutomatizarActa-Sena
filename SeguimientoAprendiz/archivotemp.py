...
df = pd.read_excel('SeguimientoAprendiz/Reporte de Juicios Evaluativos.xls',header=0,skiprows=12)
...
with pd.ExcelWriter('competencias_evaluativas.xlsx', engine='openpyxl') as writer:
    for nombre_estudiante in nombres_estudiantes:
        ...
        hoja_estudiante['C1'] = "Numero documento"
        hoja_estudiante['C2'] = numerodocumento
...
df_excel = pd.read_excel('SeguimientoAprendiz/competencias_evaluativas.xlsx')
